...
class Ui_MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.save_json_action = QAction("Export Icons")
        self.export_action = QAction("Export Items")
        self.import_action = QAction("Import Items")
        self.reload_action = QAction("Reload")
        self.close_action = QAction("Close")
        self.quit_action = QAction("Quit")
        self.file_menu.addAction(self.save_action)
        self.file_menu.addAction(self.save_json_action)
